...
import com.borshevskiy.newsapp.databinding.FragmentWallstreetBinding
...
@AndroidEntryPoint
class WallStreetFragment : Fragment() {

    private var _binding: FragmentWallstreetBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWallstreetBinding.inflate(inflater, container, false)
        setupRecyclerView()
    ...
    private fun requestApiData() {
        mainViewModel.getWallStreetNews()
        mainViewModel.wallStreetNewsList.observe(viewLifecycleOwner) { response ->
            when (response) {
