...
import com.borshevskiy.newsapp.databinding.FragmentTechcrunchBinding
...
class TechCrunchFragment : Fragment() {
    ...
    private var _binding: FragmentTechcrunchBinding? = null
    ...
    private fun requestApiData() {
        mainViewModel.getTechCrunchNews()
        mainViewModel.techCrunchNewsList.observe(viewLifecycleOwner) { response ->
            when (response) {
