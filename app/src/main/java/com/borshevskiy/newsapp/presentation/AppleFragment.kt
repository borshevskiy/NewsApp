...
import com.borshevskiy.newsapp.databinding.FragmentAppleBinding
...
class AppleFragment : Fragment() {
    ...
    private fun requestApiData() {
        mainViewModel.getAppleNews()
        mainViewModel.appleNewsList.observe(viewLifecycleOwner) { response ->
            when (response) {
